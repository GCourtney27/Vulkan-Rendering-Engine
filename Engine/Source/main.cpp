...
private:
	...
	bool hasStenilComponent(VkFormat format)
	{
	...
	void createImage(uint32_t textureWidth, uint32_t textureHeight, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
	{
	...
	void createGraphicsPipeline() 
	{
		...
		multisampling.alphaToOneEnable = VK_FALSE; // Optioanl
